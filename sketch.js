...
var score, scoreImg, score1Img, score2Img;
...
function preload()
{
  ...
  scoreImg = loadAnimation("empty.png");
  score1Img = loadAnimation("one_star.png");
  score2Img = loadAnimation("stars.png");
...
function setup() 
{
  ...
  blower.position(width-280,350)
  blower.size(120,170);
  blower.mouseClicked(airblow);

  score = createSprite(75,50,130,50);
  score.addAnimation("empty",scoreImg);
  score.addAnimation("one",score1Img);
  score.addAnimation("two",score2Img);
  score.changeAnimation("empty")
  score.scale=0.25;

  star1 = createSprite(120, 300, 50, 50);
  star1.addImage(starImg);
  star1.scale = 0.020

  star2 = createSprite(280, 80, 50, 50);
